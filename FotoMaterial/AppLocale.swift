...
final class AppLocale: ObservableObject {
    ...
    private let strings: [String: [String: String]] = [
        "es": [
            ...
            // Export / Import
            "backup.section": "Backup completo",
            "backup.export": "Exportar backup (con fotos)",
            "backup.import": "Restaurar backup",
            "backup.success": "Backup restaurado",
            "backup.error": "Error al restaurar",
        ...
        "ca": [
            ...
            "translate.ca": "Català",
            "translate.en": "English",
            "backup.section": "Backup complet",
            "backup.export": "Exportar backup (amb fotos)",
            "backup.import": "Restaurar backup",
            "backup.success": "Backup restaurat",
            "backup.error": "Error en restaurar",
        ...
        "en": [
            ...
            "backup.export": "Export backup (with photos)",
            "backup.import": "Restore backup",
            "backup.success": "Backup restored",
